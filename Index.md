...
| tests/test_transient_per_mode_integration.py | Per-mode transient integration: Spectrum kick lane, Bubble pulse, Blob deform uniforms, Heartbeat boost, GPU push pipeline (16 tests) |
