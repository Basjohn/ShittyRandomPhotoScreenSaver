...
| Builder Scaffold | ui/tabs/media/builder_scaffold.py | build_mode_scaffold, add_builder_swatch_row, ModeScaffold | Shared visualizer-mode UI scaffold for Spectrum/Oscilloscope/Sine/Blob/Bubble. Owns the repeated preset slider wiring, normal/advanced/technical container plumbing, advanced-toggle persistence, and standard swatch-row spacing so mode builders stop hand-rolling that chrome independently. |
