...
| Widget setup orchestration | `rendering/widget_setup_all.py` | Shared descriptor-driven creation/reuse/expected-overlay flow for factory-backed widgets plus explicit Spotify-dependent setup phases, including media-owned dependent setup and remote Custom visualizer reconcile once the canonical media anchor display is available |
