...
| Analog clock geometry/ticking | `widgets/clock_widget.py`, `widgets/clock_ticker.py` | Shared analogue face/card/numeral layout metrics, authored optical Roman-numeral placement map, framed outer-ring breathing-room contract, below-face timezone spacing contract, exact whole-second hand angles on the existing shared one-second ticker, and CUSTOM runtime full-rect swap ownership between digital and analogue |
