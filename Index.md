...
| Bubble Binding | ui/tabs/media/bubble_settings_binding.py | load_bubble_mode_settings(), collect_bubble_mode_settings() | Bubble-owned WidgetsTab load/save adapter so Bubble direction/color/state work does not expand the central media-tab coordinator |
