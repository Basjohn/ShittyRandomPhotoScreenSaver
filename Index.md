...
| Display participation helper | `rendering/spotify_display_participation.py` | Narrow visualizer/display owner selection helper that chooses only from participating runtime display instances when CUSTOM monitor routing points at an inactive/non-participating display |
