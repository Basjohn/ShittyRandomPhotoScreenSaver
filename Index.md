...
| Steam Abandonment visual components | `widgets/steam_abandonment_components.py` | Provider-inert authored archival layout and renderer: large cover shelf, warm archive tab, title/subtitle, reliable `LAST VISIT` stamp, optional ledger rows, Custom scaling, and dynamic-content opacity isolation |
