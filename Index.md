...
- widgets/weather_widget.py
  ...
  - Settings include `show_details_row`, `show_forecast`, and an optional “Desaturate Animated Icon” checkbox that threads through defaults/models/factories to toggle a `QGraphicsColorizeEffect` so animated art can match monochrome card themes.
