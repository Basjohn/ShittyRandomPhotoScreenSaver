...
| Steam card scaffold | `widgets/steam_card_widget.py` | Dev-gated static Steam card overlays used to validate descriptor/factory/settings/Custom plumbing before production data or paint helpers are wired |
