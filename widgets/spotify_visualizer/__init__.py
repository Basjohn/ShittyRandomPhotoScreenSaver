...
- widget: Main SpotifyVisualizerWidget UI component

Usage:
    from widgets.spotify_visualizer import SpotifyVisualizerWidget
    from widgets.spotify_visualizer import get_shared_spotify_beat_engine
"""

from widgets.spotify_visualizer.widget import SpotifyVisualizerWidget
