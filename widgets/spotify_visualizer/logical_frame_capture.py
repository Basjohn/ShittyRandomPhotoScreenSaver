"""Authoritative logical-frame capture for the retained Quick visualizer.

The controller-owned logical tick state and mode runtimes are copied into one
detached immutable ``VisualizerLogicalFrame``.  This module owns no QWidget,
QQuickItem, paint callback, render cadence, or compatibility presenter.
"""
...
def capture_visualizer_logical_frame(
    widget: Any,
    *,
    now_ts: float,
    changed: bool,
...
__all__ = ["capture_visualizer_logical_frame"]
