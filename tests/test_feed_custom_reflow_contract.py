"""Import-free guards for FEEDS Custom 1 independent X/Y and child reflow."""
...
def test_feed_descriptor_and_retained_model_own_independent_xy_extent():
    ...
    start = descriptors.index('widget_id="feeds_custom_1"')
    block = descriptors[start:descriptors.index("WidgetRuntimeDescriptor(", start + 40)]
