...
# Removed the three retired QWidget-anchor cells (test_real_media_anchor_setup_
# injects_and_reuses_mute_owner, test_two_media_anchors_share_mute_owner_until_
# final_cleanup, test_disabled_system_mute_builds_no_owner_or_backend): all drove
# rendering.widget_setup_all._setup_media_owned_spotify_dependents +
# rendering.widget_manager.WidgetManager + widgets.media_widget.MediaWidget,
# deleted in the Qt Quick cutover. Shared mute-owner injection/reuse, cross-anchor
# sharing and disabled-builds-no-owner are covered by the widget_runtime_services
# cells above and shared_system_mute_owner_count().
