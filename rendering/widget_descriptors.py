...
WIDGET_SETTINGS_SECTION_DESCRIPTORS: tuple[WidgetSettingsSectionDescriptor, ...] = (
    ...
    WidgetSettingsSectionDescriptor(
        ...
        signal_block_attrs=(
            ...
            "media_volume_fill_color_btn", "media_volume_border_color_btn",
            "media_artwork_size", "media_rounded_artwork",
            "media_show_header_frame", "media_show_album", "media_show_playback_state",
            "media_show_controls",
    ...
    WidgetSettingsSectionDescriptor(
        section_id="feeds",
        button_label="Feeds",
        button_attr_name="_btn_feeds",
        container_attr_name="_feeds_container",
        builder_module="ui.tabs.widgets_tab_feeds",
        builder_name="build_feeds_ui",
        loader_module="ui.tabs.widgets_tab_feeds",
        loader_name="load_feeds_settings",
        loader_guard_attrs=("feeds_custom1_enabled",),
        saver_module="ui.tabs.widgets_tab_feeds",
        saver_name="save_feeds_settings",
        saver_guard_attrs=("feeds_custom1_enabled",),
        persisted_widget_keys=("feeds_custom_1",),
        signal_block_attrs=(
            "feeds_custom1_enabled", "feeds_custom1_name", "feeds_custom1_url",
            "feeds_custom1_view_mode", "feeds_custom1_item_limit",
            "feeds_custom1_refresh_minutes",
            "feeds_custom1_position", "feeds_custom1_monitor_combo",
            "feeds_custom1_margin", "feeds_custom1_font_combo", "feeds_custom1_font_size",
            "feeds_custom1_preferred_width", "feeds_custom1_preferred_height",
            "feeds_custom1_show_background", "feeds_custom1_bg_opacity",
            "feeds_custom1_border_opacity",
        ),
    ),
    WidgetSettingsSectionDescriptor(
        section_id="gmail",
    ...
    WidgetSettingsSectionDescriptor(
        ...
        signal_block_attrs=(
            ...
            "abandonment_issues_font_family",
            "abandonment_issues_font_size",
            "abandonment_issues_selection_mode",
            "abandonment_issues_pinned_game",
            "abandonment_issues_minimum_playtime_minutes",
            ...
            "abandonment_issues_show_achievements",
            "abandonment_issues_show_last_unlock",
            "abandonment_issues_show_last_played",
            "abandonment_issues_show_archive_class",
            "abandonment_issues_show_queue",
            "abandonment_issues_show_source",
            "abandonment_issues_show_pinned",
    ...
    WidgetSettingsSectionDescriptor(
        section_id="system_audio_osd",
        button_label="Volume OSD",
        button_attr_name="_btn_system_audio_osd",
        container_attr_name="_system_audio_osd_container",
        builder_module="ui.tabs.widgets_tab_system_audio_osd",
        builder_name="build_system_audio_osd_ui",
        loader_module="ui.tabs.widgets_tab_system_audio_osd",
        loader_name="load_system_audio_osd_settings",
        loader_guard_attrs=("system_audio_osd_enabled",),
        saver_module="ui.tabs.widgets_tab_system_audio_osd",
        saver_name="save_system_audio_osd_settings",
        saver_guard_attrs=("system_audio_osd_enabled",),
        persisted_widget_keys=("system_audio_osd",),
        signal_block_attrs=("system_audio_osd_enabled", "system_audio_osd_position",
                            "system_audio_osd_monitor_combo", "system_audio_osd_inactivity_ms",
                            "system_audio_osd_text_position", "system_audio_osd_font_family",
                            "system_audio_osd_font_size", "system_audio_osd_bar_thickness",
                            "system_audio_osd_preferred_width", "system_audio_osd_preferred_height"),
    ),
    WidgetSettingsSectionDescriptor(
        section_id="defaults",
...
WIDGET_CUSTOM_RESIZE_LOCK_DESCRIPTORS: tuple[WidgetCustomResizeLockDescriptor, ...] = (
    ...
    WidgetCustomResizeLockDescriptor(
        ...
        widget_ids=("feeds_custom_1",),
        position_combo_attrs=("feeds_custom1_position",),
        control_attrs=(
            "feeds_custom1_font_size",
            "feeds_custom1_preferred_width",
            "feeds_custom1_preferred_height",
        ),
        anchor_attr="feeds_custom1_preferred_width",
    ),
    WidgetCustomResizeLockDescriptor(
        section_id="gmail",
    ...
    WidgetCustomResizeLockDescriptor(
        ...
        widget_ids=("system_audio_osd",),
        position_combo_attrs=("system_audio_osd_position",),
        control_attrs=("system_audio_osd_font_size", "system_audio_osd_preferred_width",
                       "system_audio_osd_preferred_height", "system_audio_osd_bar_thickness"),
        anchor_attr="system_audio_osd_preferred_width",
    ),
    WidgetCustomResizeLockDescriptor(
        section_id="system_stats",
...
WIDGET_CUSTOM_POSITION_OPTION_DESCRIPTORS: tuple[WidgetCustomPositionOptionDescriptor, ...] = (
    ...
    WidgetCustomPositionOptionDescriptor("feeds_custom_1", "feeds_custom1_position"),
    ...
    WidgetCustomPositionOptionDescriptor("system_audio_osd", "system_audio_osd_position"),
)
...
WIDGET_RUNTIME_DESCRIPTORS: tuple[WidgetRuntimeDescriptor, ...] = (
    ...
    WidgetRuntimeDescriptor(
        ...
        attr_name="abandonment_issues_presentation",
        settings_section_id="steam",
    ...
    WidgetRuntimeDescriptor(
        widget_id="system_audio_osd",
        attr_name="system_audio_osd_presentation",
        settings_section_id="system_audio_osd",
        settings_prefixes=("widgets.system_audio_osd",),
        startup_stage="primary",
        service_backed=True,
        supports_layout_edit_mode=True,
        supports_custom_position_slot=True,
        ...
        custom_layout_resize_mode="ordinary_uniform",
        content_extent_axes=("horizontal", "vertical"),
        content_extent_minimum_size=(180, 48),
        position_option_labels=STANDARD_POSITION_OPTION_LABELS
        + (CUSTOM_POSITION_OPTION_LABEL,),
    ),
    WidgetRuntimeDescriptor(
...
#
# Widget family capability catalog
# --------------------------------
# The catalog itself lives in the presentation-neutral
# ``core.settings.widget_family_catalog`` module so the capability activation
# authority and the future ``WidgetRuntimeManager`` can consume it without
# pulling QtWidgets / family-implementation imports. ``WidgetFamilyDescriptor``,
# ``WIDGET_FAMILY_DESCRIPTORS``, ``get_widget_family_descriptor(s)`` and
# ``get_family_id_for_widget`` are imported/re-exported at the top of this module
# to keep existing rendering-side callers working. Family membership and
# family-level availability are single-sourced in that neutral module; only the
# member-level runtime availability below is resolved from runtime descriptors.
#
