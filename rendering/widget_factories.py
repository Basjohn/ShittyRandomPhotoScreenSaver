...
class ClockWidgetFactory(WidgetFactory):
    ...
    def create(
        ...
        *,
        ...
        from core.settings.models import WidgetPosition
        ...
        try:
            ...
            resolved_widget_pos = normalize_widget_position(
                _resolve_style('position', default_pos),
                normalize_widget_position(default_pos, WidgetPosition.TOP_RIGHT),
            )
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            widget_pos = normalize_widget_position(config.get('position', 'Top Left'), WidgetPosition.TOP_LEFT)
...
class MediaWidgetFactory(WidgetFactory):
    ...
    def create(
        ...
        *,
        ...
        from core.settings.models import MediaWidgetSettings, WidgetPosition
        from core.settings.normalization import normalize_widget_position
        ...
        try:
            ...
            widget_pos = normalize_widget_position(model.position, WidgetPosition.BOTTOM_LEFT)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            widget_pos = normalize_widget_position(model.position, WidgetPosition.TOP_RIGHT)
            position = position_map.get(widget_pos, RedditPosition.TOP_RIGHT)

            # DEBUG: Log position application for Reddit widgets (always log for debugging)
            logger.debug("[REDDIT_FACTORY] Creating %s: model.position=%s, widget_pos=%s, reddit_position=%s",
                       settings_key, model.position, widget_pos, position)
