  ...
  kids=[
    StringFileInfo(
      ...
      StringTable(
        ...
        StringStruct(u'InternalName', u'{APP_EXE_NAME} MC'),
        StringStruct(u'LegalCopyright', u'Copyright (c) {APP_COMPANY}'),
        StringStruct(u'OriginalFilename', u'{APP_EXE_NAME} MC.exe'),
...
a = Analysis(
    ['F:\\Programming\\Apps\\ShittyRandomPhotoScreenSaver\\main_mc.py'],
    pathex=[],
    binaries=binaries,
    datas=datas,
