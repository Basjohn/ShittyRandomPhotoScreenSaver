...
_BASE_CONTROL_DEFS: tuple[_ControlDef, ...] = (
    ...
    _ControlDef(
        control_key="energy_boost_slider",
        config_key="energy_boost",
        default_key="energy_boost",
        widget_kind="slider",
        default_type="float",
        base_default=0.85,
        label_key="energy_boost_label",
        minimum=0.5,
        maximum=1.8,
        scale=100.0,
        hidden=True,
    ...
    _ControlDef(
        control_key="raw_energy",
        config_key="use_raw_energy",
        default_key="use_raw_energy",
        widget_kind="checkbox",
        default_type="bool",
        base_default=False,
        checkbox_text="Use Raw (Pre-AGC) Energy",
        circle_indicator=True,
        hidden=True,
    ),
    _ControlDef(
