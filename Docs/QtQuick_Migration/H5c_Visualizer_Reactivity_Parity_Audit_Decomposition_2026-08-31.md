...
- [ ] Pin and correct entry/exit/cluster/retry content-space constants, then isolate impulse application; collision detection/correction retains its existing height-domain contract until a dedicated two-bubble A/B proves otherwise.
