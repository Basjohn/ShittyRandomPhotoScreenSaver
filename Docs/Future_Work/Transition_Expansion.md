...
- [~] **Melt — gloss and detail.** Reworked with the Melt rework. Measured on real photographs at 40% (inside the melting region, 60–70% of the frame): detail 0.5↔2.0 changes 43–50/255 mean, depth 0↔1 14–17/255, gloss 0↔1 16–21/255 (wet sheen plus highlights; silhouette unchanged). Both former reds (`test_liquid_material_controls_affect_the_melt[gloss]`, `test_authored_controls_change_rendered_pixels[melt_drip-detail-2.0]`) are green. Physical: operator judges the min/mid/max look at authored durations.
