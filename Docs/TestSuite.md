...
```text
test-inventory basis = F3 retained Media-core implementation
Phase F0/F0.5/F1/F2 CLOSED; 360 test modules; F3 Media core active
```
...
### F — widget family ports — ACTIVE; F1 Clock/F2 Weather CLOSED, F3 Media core ACTIVE
