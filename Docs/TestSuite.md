...
```text
test-inventory basis = F2 retained Weather implementation
Phase F0/F0.5/F1 CLOSED; 359 test modules; F2 Weather retained implementation active
```
...
registry and retained item/model/runtime/engine identity. Real-OpenGL eyes-on evidence is generated by
