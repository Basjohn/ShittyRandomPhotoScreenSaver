...
```text
test-inventory basis = F2 retained Weather implementation + pixel retirement
Phase F0/F0.5/F1/F2 CLOSED; 359 test modules; F3 Media core active
```
