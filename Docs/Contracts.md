...
| Shared overlay painted-frame cache | `widgets/base_overlay_widget.py` | `Docs/10_WIDGET_GUIDELINES.md`, `Docs/audits/SRPSS_Architecture_Roadmap/08_CPU_THREADING_AND_WORKLOAD_PLAN.md` | GUI-owned exact size/DPR/style/revision preparation at state commits; paint validates and blits only; custom-shaped painters opt out explicitly |
