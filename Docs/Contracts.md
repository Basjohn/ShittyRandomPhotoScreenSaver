...
| Widget data/provider lifecycle | per-instance services or family-shared leases through `WidgetRuntimeManager` according to real cardinality; shared Media/Gmail and separate app-volume/system-mute owners landed; import dormancy/owner hoist remain; **E1 active** | `Docs/QtQuick_Migration/04_Widget_Runtime_Presentation.md`, `Docs/QtQuick_Migration/08_Widget_Runtime_Ownership_Threading.md` |
