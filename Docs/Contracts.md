...
| Visualizer cadence/presentation/repaint | visualizer tick owner plus display presentation | `Docs/Guardrails/Visualizer_Presentation.md` | One cadence authority; a presentation source must be live whenever the visualizer is |
