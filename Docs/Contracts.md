...
| Widget data/provider lifecycle | migrated per-instance services through `WidgetRuntimeManager`; preserve already-correct shared/family owners; **E1 active** | `Docs/QtQuick_Migration/04_Widget_Runtime_Presentation.md`, `Docs/QtQuick_Migration/08_Widget_Runtime_Ownership_Threading.md` |
