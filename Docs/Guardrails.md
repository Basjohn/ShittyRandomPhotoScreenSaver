...
- Cached active descriptor views are acceptable, but they must stay environment/dev-gate-aware so gated families such as Imgur or Steam do not go stale across tests or runtime toggles.
