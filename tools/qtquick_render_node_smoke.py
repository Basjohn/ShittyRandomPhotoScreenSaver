...
class _SmokeRunner(QObject):
    ...
    def _begin_hide_show_cycle(self, token: int) -> None:
        ...
        try:
            for probe in self._probes:
                ...
                probe.runtime.frame_pacer.set_transition_active(True)
    ...
    def _begin_topology_displacement(self, token: int) -> None:
        ...
        try:
            ...
            displaced.runtime.frame_pacer.set_transition_active(True)
    ...
    def _poll_topology_displacement(self, token: int) -> None:
        ...
        ready = bool(
            ...
            and pacer_state.get("demands") == ["transition"]
    ...
    def _validate_probe(
        ...
        for cycle_index, cycle in enumerate(probe.hide_show_cycles):
            ...
            if (
                ...
                or hidden_pacer.get("demands") != ["transition"]
            ):
            ...
            if (
                ...
                or resumed_pacer.get("demands") != ["transition"]
            ):
