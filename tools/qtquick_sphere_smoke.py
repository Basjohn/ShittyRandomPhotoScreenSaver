...
from PySide6.QtCore import QObject, Qt, QTimer, Slot, QSize, QMetaObject, Signal
...
from widgets.spotify_visualizer.render_state import (
    SphereFrame, VisualizerCommonState, VisualizerEnergyState, VisualizerLogicalFrame,
...
class _Runner(QObject):
    ...
    def __init__(self, app, args):
        ...
        for index, material in enumerate(materials):
            ...
            width, height = args.extent_width * args.scale, args.extent_height * args.scale
        ...
        for material, item, bridge, p, _parent in self.entries:
            logical = VisualizerLogicalFrame(
                ...
                common=VisualizerCommonState(bars=(), bar_count=0,
                    energy=VisualizerEnergyState(bass=args.bass, mid=args.mid, high=args.high, overall=.5)),
                mode_state=SphereFrame(authored_time=3.4 + self.frame_number / 60.0,
                    parameters=freeze_render_fields({"sphere_material": material})),
            )
